...
export default function Home() {
  ...
  const renderQuizSection = (id, question, imageSrc, options, correctAnswer, feedbackImage, feedbackText) => {
    ...
    console.log('isAnswered:', isAnswered, 'isCorrect:', isCorrect, 'selectedOption:', selectedOption);

    return (
      <section className={styles.quizContainer} id={id}>
        <h2>{question}</h2>
        <div className={styles.quizImage}>
          <Image width={720} height={476} src={imageSrc} alt="クイズ画像" />
        </div>
  ...
  return (
    <>
      ...
      <section className={styles.firstView}>
        <div className={styles.exploretitle}>
          ...
          <Image
            ...
            width={1080}
            height={714}
            src="https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/SFCMap.png"
            alt="地図"
          />
        </div>
      </section>
      ...
      {renderQuizSection(
        ...
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/Quiz01.jpg',
        ['SFC', 'FAB', 'MCR'],
        'FAB',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'FABでは3Dプリンターやレーザーカッターが無料で利用でき、様々なモノ作りを体験することができます。合言葉：不動'
      )}
      ...
      {renderQuizSection(
        ...
        'レディバード',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'レディバードでは、『リターナブル容器』に変更することでゴミ資源を削減しつつお得に食べることができます。合言葉：回り道'
      )}
      ...
      {renderQuizSection(
        ...
        '食堂',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        '食堂で無料でレジャーシートが借りられます。気分転換に鴨池前の芝生でランチをしてみましょう！合言葉：サザンカ'
      )}
      ...
      {renderQuizSection(
        ...
        'フェニックス',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'DSや体育、研究会などによって故意でなく原級してしまうSFC生が多々見受けられます。このような事にならないように履修はしっかり考えましょう'
      )}
      ...
      {renderQuizSection(
        ...
        '鴨池ラウンジ',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'コンビニに併設している鴨池ラウンジには仕切りのついたソファや大人数用の机があります。隙間時間に行ってみましょう！'
      )}
      ...
      {renderQuizSection(
        ...
        'ジム',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'ガンマ館は体育館アリーナだけではなく、学生が無料で利用できるジムがあります！運動したい時に行ってみましょう！'
      )}
      ...
      {renderQuizSection(
        ...
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/Quiz01.jpg',
        ['電子機器サポートセンター', 'AVカウンター', 'カメラの窓口'],
        'AVカウンター',
        'https://web.sfc.keio.ac.jp/~t22934mw/wpx/wp-content/uploads/2024/12/IMG_6151-scaled.jpg',
        'メディアセンター内のAVカウンターでは、SFC生であれば無料でカメラをレンタルできます！学生生活の思い出や経験を記録として残してみませんか？'
      )}
    </>
  );
}
